...
namespace MotorOnline
{
    public class cls_base_page : System.Web.UI.Page
    {
        ...
        public void uf_populate_ddlb(DevExpress.Web.ASPxEditors.ASPxComboBox ao_ddlb, DataTable adt_source, bool ab_empty_option = true, string as_empty_option_text ="Select", string as_valuefield = "VALUE", string as_textfield = "TEXT")
        {
            DataRow ldr_empty_row = adt_source.NewRow();

            ldr_empty_row[as_valuefield] = 0;
            ldr_empty_row[as_textfield] = as_empty_option_text;

            adt_source.Rows.InsertAt(ldr_empty_row, 0);

            ao_ddlb.DataSource = adt_source;
            ao_ddlb.Value = as_valuefield;
            ao_ddlb.Text = as_textfield;
            ao_ddlb.DataBind();
        }
